...
function About() {
  ...
  return (
    <motion.div
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="ap-title">
                  <h2>Welcome To Saradha.</h2>
                  <p>Welcome to Shradha Hotel, where comfort meets luxury! Our hotel is located in the heart of Birtamode, Jhapa, providing easy access to all the city's major attractions. Whether you're in town for business or pleasure, our hotel offers exceptional amenities to make your stay unforgettable. With modern and tastefully designed rooms, we offer the perfect setting for a peaceful and comfortable night's sleep. Our friendly and professional staff are always on hand to assist you, ensuring that you have a hassle-free stay. At Shradha Hotel, we take pride in providing our guests with an exceptional experience, so book your stay with us today and let us take care of the rest!
              ...
              <div className="col-lg-5 offset-lg-1">
                <ul className="ap-services">
                  ...
                  <li><i className="icon_check" /> Parking Facilities</li>
                  <li><i className="icon_check" /> Event Hall</li>
                  <li><i className="icon_check" /> 24/7 Security</li>
                  <li><i className="icon_check" /> Roof Top View</li>
                </ul>
              </div>
            </div>
          </div>
          <div className="about-page-services">
            <div className="row">
              <div className="col-md-12 col-lg-3">
                <div className="ap-service-item set-bg" style={{ backgroundImage: `url(${b})` }}>
      ...
      {/* Video Section Begin */}
      <section className="video-section set-bg" style={{ backgroundImage: `url(${vbg})` }}>
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="video-text">
                <h2>Discover Our Hotel &amp; Services.</h2>
                <p> Welcome to Shradha Hotel, where comfort meets luxury! Our hotel is located in the heart of Birtamode, Jhapa, providing easy access to all the city's major attractions. Whether you're in town for business or pleasure, our hotel offers exceptional amenities to make your stay unforgettable. With modern and tastefully designed rooms, we offer the perfect setting for a peaceful and comfortable night's sleep. Our friendly and professional staff are always on hand to assist you, ensuring that you have a hassle-free stay. At Shradha Hotel, we take pride in providing our guests with an exceptional experience, so book your stay with us today and let us take care of the rest!</p>
